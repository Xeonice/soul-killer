...
import type { CaptureProgress, CaptureResult } from './strategy/capture-strategy.js'
import type { DistillAgentProgress, DistillResult } from '../distill/distill-agent.js'
import type { TagSet } from '../tags/taxonomy.js'
import type { SoulType } from '../soul/manifest.js'
import type { AgentPhase } from './strategy/capture-strategy.js'
