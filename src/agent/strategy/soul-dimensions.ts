import type { DimensionDef, DimensionPlan as UnifiedDimensionPlan } from '../planning/dimension-framework.js'
import { signalsToRegex } from '../planning/dimension-framework.js'
