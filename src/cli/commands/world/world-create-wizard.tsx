...
import type {
  WorldType,
  WorldClassification,
} from "../../../world/capture/world-dimensions.js";
import type { CaptureProgress } from "../../../infra/agent/capture-strategy.js";
import type {
  ToolCallDisplay,
  AgentPhase,
  ...
  async function startDistill() {
    ...
    try {
      ...
      if (
        ...
        const plan: import("../../../infra/agent/dimension-framework.js").DimensionPlan =
          {
